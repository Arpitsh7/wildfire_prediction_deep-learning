"""
MNDWS Data Training Script
- Dataset: MNDWS (processed_mndws)
- Model: AttentionUNet (22 input channels from MNDWS)
- Loss: WBCEDiceLoss (pos_weight=25, dice_weight=1.5)
- Threshold: 0.85
- Min Area: 25 (post-processing)
"""
...
def main():
    ...
    log_file = os.path.join(base_dir, "training_mndws.log")
    ...
    print(f"""
================================================================================
              MNDWS TRAINING: WBCEDiceLoss + POST-PROCESSING
...
"""
    ...
    data_path = os.path.join(base_dir, "data", "processed_mndws")
    
    log_to_file("\nLoading MNDWS dataset...")
    ...
    model_path = os.path.join(checkpoint_dir, "mndws_apau_net.pth")
    ...
    results_path = os.path.join(results_dir, "mndws_training_results.json")
