#!/usr/bin/env python3
"""
Hyperparameter Optimization for APAU-Net - FIXED VERSION
- Uses already trained v2 model
- Tests different min_area and threshold values
- CRITICAL: Normalizes using TRAINING SET stats
"""
...
def load_data():
    ...
    # Normalize test set using training set stats
    logger.info("Normalizing test data using training set statistics...")
...
def main():
    logger.info("="*80)
    logger.info("APAU-Net Hyperparameter Optimization (FIXED)")
    logger.info("="*80)
    ...
    # Load test data with correct normalization
    ...
    results_file = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
        'results',
        'optimization_results_phase1_fixed.json'
    )
